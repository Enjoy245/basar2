...
message.channel.send(`:white_check_mark: ${channel} başarıyla kilitlendi.`).then(m => m.delete({timeout: 7000}));
...
.setDescription(` :warning: Bu kanal, kilitlenmek zorunda kaldı. Lütfen sabırla yetkililerin açmasını bekleyiniz.`));
